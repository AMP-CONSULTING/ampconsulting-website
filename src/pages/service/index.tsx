                    ...
                    <div className="grid grid-cols-2 gap-6 mb-8">
                        {/* <div className="w-[349px] h-[130px] rounded-[20px] border border-[#BBBBBB] flex items-center justify-start gap-8 pl-8">
                            ...
                            <div className='flex flex-col gap-3'>
                                <h3 className='mb-0 font-poppins font-semibold text-[16px] text-[#414141] leading-[25px]'>
                                    Kepatuhan Perpajakan<br />
                                    Untuk Korporasi
                                </h3>
                                <Link to={"https://wa.me/6281298036123"} target='_blank' className='w-[129px] h-[36px] rounded-[10px] bg-[#55E26F] hover:bg-[#29DA4B] font-poppins font-semibold text-[10px] text-white flex items-center gap-2 pl-2'>
